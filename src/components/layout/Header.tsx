                    ...
                    <nav className={cn(
                        ...
                        {["Home", "Auctions", "Motors", "Real Estate", "About"].map((item) => (
                            <Link
                                ...
                                className="px-5 py-2 rounded-full text-sm font-bold transition-all duration-300 text-slate-900 dark:text-white hover:text-accent dark:hover:text-accent"
                            >
                                {t(item)}
                            </Link>
                        ))}
                    ...
                    <div className="flex items-center gap-3 relative">
                        ...
                        <div className="hidden sm:flex gap-2 ms-2">
                            <Button
                                ...
                                className="rounded-full transition-all font-bold px-5 text-slate-900 dark:text-white hover:bg-slate-100 dark:hover:bg-white/10"
                            >
                                {t("Log In")}
                            </Button>
                            <Button
                                onClick={() => openAuthModal("signup")}
                                className="rounded-full bg-accent hover:bg-accent/90 dark:bg-white dark:hover:bg-white/90 text-white dark:text-slate-950 shadow-xl shadow-accent/20 dark:shadow-white/10 transition-all hover:scale-105 active:scale-95 font-bold px-7 border-none h-11"
                            >
                                {t("Get Started")}
                            </Button>
                        </div>
